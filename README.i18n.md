...
In order to use the same translation workflow as the [Monero Core GUI](https://github.com/xcash-project/xcash-core), they use Qt Linguist translation files.  However, to avoid the dependencies on Qt this normally implies, they use a custom loader to read those files at runtime.
